...
@section('content')
    <div class="container">
        ...
        <form action="{{ isset($menu->id) ? route('menus.update', $menu->id) : route('menus.store') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="new-position-container" class="d-none">
                                ...
                                <button type="button" id="save-new-position" class="btn btn-primary mt-2">Save Position</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-primary mt-3">{{ isset($menu->id) ? 'Update' : 'Create' }}</button>
        </form>
    </div>
