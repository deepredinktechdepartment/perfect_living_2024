...
CREATE TABLE `projects` (
  ...
  `company_id_1` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `projects` (`id`, `name`, `slug`, `is_featured`, `company_id`, `company_id_1`, `site_address`, `logo`, `website_url`, `latitude`, `longitude`, `master_plan_layout`, `about_project`, `city`, `area`, `elevation_pictures`, `enquiry_form_url`, `map_collections`, `map_badges`, `amenities`, `project_type`, `no_of_acres`, `no_of_towers`, `no_of_units`, `price_per_sft`, `price_range_start`, `price_range_end`, `status`, `created_at`, `updated_at`) VALUES
(9, 'The Botanika', 'the-botanika', 1, '[\"4\"]', 0, 'https://maps.app.goo.gl/c5jWtgbABjgTsFBL8', 'projects/bEdfbEkrbCxW7dlIIcB7fmgh1mglNTScbRTltmUS.png', 'https://botanika.in/', '17.451309397154446', '78.36475534299113', 'projects/BHWQemfwu7fkQf79bddTpZeUw1UfVs94Y90dEsdm.png', '<p>Every morning at The Botanika, you wake up to 200 acres of The Botanical Garden\'s greenery, Surround yourself with incredible open spaces, and feel the freshness, as luxury takes on a green hue. Rejuvenate yourself as you breathe in the pure morning air. After all, this is a community where every day you experience tranquility.</p>\r\n<p>Indulge in a host of stellar amenities like a fully equipped multi-cuisine fine dining restaurant, a Business center with modern conferencing facilities, a mini-movie theater, and the best of sports, health, and fitness facilities in a 40,000 sq.ft</p>\r\n<p>&nbsp;</p>', 2, 2, NULL, NULL, '[\"2\",\"3\",\"4\"]', '[\"8\",\"9\",\"10\"]', NULL, 'Apartment Gated Community', '1.5', '5', '400', 6000, 1, 1.5, 'deactivated', '2024-09-06 18:21:53', '2024-09-20 09:27:50'),
(10, 'Nestcon', 'nestcon', 1, '[\"4\"]', 4, 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7610.371762867956!2d78.494558!3d17.498638!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9bc48815656f%3A0x84b465af924ddcdc!2sNestcon\'s%20Dhruva%20Tara!5e0!3m2!1sen!2sin!4v1725873444605!5m2!1sen!2sin', 'projects/q24Q4ty9zuTBvbPguuAXgP5sxn9vpogdsVqdiSl4.png', 'https://nestcon.com', '17.506882566072722', '78.55340169161568', 'projects/qpXwyMeoI7OqZqd4nEfexRHxoSGuw1Ex9iyBKLwK.png', '<p>With an extensive experience of nearly two decades, Nestcon has embarked on this esteemed standalone project in Alwal, Secunderabad, to deliver quality constructions on time and within budget. The project is designed to offer you an exclusive lifestyle complemented by eco-friendly features for sustainable living. It is a project of&nbsp;<strong>3BHK luxury apartments in Nagireddy Colony, Alwal, Secunderabad.</strong></p>\r\n<p>If you want to speak with our authorized sales representative about the property and get the best deals, please contact us using the details listed below.</p>\r\n<p><strong>RERA Approved No: P02400004542</strong></p>\r\n<p>Ph:&nbsp;<a href=\"tel:+91-8431320000\">+91-8431320000</a>&nbsp;, +91-9052233233&nbsp; &nbsp; &nbsp;Email:&nbsp;<a href=\"mailto:sales@nestcon.com\">sales@nestcon.com</a></p>', 2, 3, NULL, NULL, '[\"2\",\"3\",\"4\"]', '[\"8\",\"9\",\"10\"]', NULL, 'Standalone Villa', '2', '30', '600', 6000, 1.5, 2, 'in_review', '2024-09-09 14:42:07', '2024-09-20 10:53:16'),
(11, 'A2A Homeland', 'a2a-homeland', 1, '[\"2\",\"6\"]', 6, 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15222.109260910875!2d78.4452824!3d17.4823239!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9195fed45b69%3A0xa516f048c1aaee49!2sA2A%20Homeland!5e0!3m2!1sen!2sin!4v1726748287298!5m2!1sen!2sin', 'projects/HwWLhyOy4ya8Fjs2lcgrk2gvxJyBvaNv1d86Sg8e.jpg', 'https://a2ahomeland.in/', NULL, NULL, 'projects/cWPdcxoKtCmNrVJfjYyfHSlp4UFY1AuyElzWcEkf.jpg', '<p>test</p>', 2, 4, NULL, NULL, NULL, NULL, NULL, 'Apartment Gated Community', '12', '7', '1162', 5000, 2, 2.5, 'published', '2024-09-19 16:11:52', '2024-09-20 11:06:56');
...
(192, NULL, NULL, 'Ranjith', '9898989892', 'ranjith@deepredink.com', '$2y$10$7s/1ZX2fDKsLkAw0dpZG.u/AjZKgTIZxH9ma2UoHFdi8YoUBsliem', NULL, NULL, 'default_profile_pic.png', 1, NULL, 1, '2024-09-11 10:43:22', '2024-09-20 07:39:16', '2024-09-20 09:59:25', '106.222.232.129', NULL, '2024-09-20 05:46:15', '::1'),
...
(194, NULL, NULL, 'Purnavi', '9182805457', 'purnavi@deepredink.com', '$2y$10$pqiKQCnOIe9Xvdzppj3DrODJAUbkE88EV8Yf7Qurp.nkS500g7EZO', NULL, NULL, 'default_profile_pic.png', 4, NULL, 1, '2024-09-11 12:19:04', '2024-09-19 23:00:48', '2024-09-19 15:20:46', '106.222.232.129', NULL, '2024-09-19 23:00:48', '152.58.233.176'),
...
--
ALTER TABLE `projects`
  ADD CONSTRAINT `fk_company` FOREIGN KEY (`company_id_1`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_company_key` FOREIGN KEY (`company_id_1`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `projects_company_id_foreign` FOREIGN KEY (`company_id_1`) REFERENCES `companies` (`id`) ON DELETE CASCADE;
